  ...
  return (
    <div className="product-card" onClick={handleCardClick} role="button" tabIndex={0} onKeyDown={e => e.key === 'Enter' && handleCardClick()}>
      <div className="product-image-wrap">
        ...
        <img src={product.mainImage} alt={product.name} className="product-image" loading="lazy" />
        <button className="mobile-cart-badge" onClick={handleAddToCart} aria-label="Add to cart" type="button">
          <ShoppingBag size={14} />
        </button>
      </div>
      <div className="product-info">
        ...
        <div className="product-bottom-row">
          ...
          <button className="product-add-btn" onClick={handleAddToCart} type="button" aria-label="Add to cart">
            Add to Cart
          </button>
        </div>
      </div>
